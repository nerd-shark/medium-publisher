...
Let's start with what we know. Seventy-nine percent of organizations are deploying or experimenting with agentic AI (Gartner, 2025). The market is growing at 43.8% CAGR, from $5.25 billion in 2024 to a projected $199 billion by 2034. Forty-three percent of companies are allocating more than half their AI budgets to agentic systems.

Those are adoption numbers, not ROI numbers. There's a difference.

The headline ROI figure that gets passed around is 171% average return — 192% for US enterprises specifically. That comes from industry surveys, and I'd treat it with some skepticism. Survey respondents who invested heavily in AI agents have an incentive to report positive returns. The organizations that quietly shelved their agent projects aren't filling out surveys about it.

What I've seen in practice is more nuanced. Some agent deployments deliver genuinely transformative returns — 5x to 10x cost reduction in specific workflows. Others break even. A few lose money when you account for the full cost stack. The difference almost always comes down to whether the team picked the right problem and measured the right things.
...
That's a strong case. But change the volume to 1,000 documents per month and the agent cost per document jumps to $15 (fixed costs don't scale down), the monthly savings evaporate, and the project loses money.

Volume is the single biggest variable in agent ROI. If you're not confident in your volume projections, you're not confident in your ROI.
...
The organizations getting real value from agentic AI aren't the ones with the most agents. They're the ones who can tell you, to the dollar, what each agent costs and what it saves. That's a less exciting story than "AI is transforming everything," but it's the one that survives budget season.
