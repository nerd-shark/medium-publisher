...
changes-from-v3: "Polished introduction for stronger series finale framing. Refined the honest assessment section with more nuanced take on job displacement. Added brief section on what they'd do differently with hindsight. Strengthened series callback connections. Polished conclusion for emotional resonance as series finale. Final SEO review."
---

# The Agent That Replaced a Department: An Agentic AI Capstone Case Study

Every series needs a finale that earns its place. Over the past seven articles, we've built something together — a shared vocabulary for understanding agentic AI. We started with the [evolution from chatbots to agents](link), dissected [agent anatomy](link), explored [multi-agent collaboration](link), got our hands dirty [building a first agent](link), designed the [Promise/Work orchestration pattern](link), went deep on [memory systems](link), and confronted the hard math of [ROI analysis](link). Theory, architecture, patterns, economics — all of it leading here.
...
The orchestrator's confidence threshold was the most debated design decision. Too high (98%) and almost nothing gets auto-processed — defeats the purpose. Too low (80%) and you get unacceptable error rates. They started at 95% and tuned down to 92% over the pilot as they gained confidence in the agents' accuracy. The 92% threshold was the sweet spot: it captured 83% of claims while maintaining 96.3% accuracy on the auto-processed subset.
...
And it displaced 28 jobs. That's not an abstraction — it's 28 people who had to find new roles, retrain, or leave the company. The team handled it as humanely as possible: eight months of transition, internal transfers where available, retraining stipends, and generous severance for those who left. Nobody was blindsided. But let's not pretend that makes it painless. The people who left had built careers around expertise that an AI system now performs in minutes. That's a real loss — of identity, of purpose, of economic security — even when the transition is managed well. The remaining 19 roles are higher-skilled and higher-paid (senior reviewers, ML engineers, system architects), which is genuinely good for those individuals. But "the remaining jobs are better" is cold comfort to the people who no longer have one.

The organizations that will get the most value from agentic AI are the ones that approach it like Meridian did: start with a specific, high-volume problem. Build incrementally. Measure honestly. Invest in memory and feedback loops. Plan for the organizational impact — including the human cost. And set expectations that match reality, not the demo.

That's the series. Eight articles, eight months of writing, and one core conviction: agentic AI is real, it works, and it matters — but only if you approach it with the same rigor you'd bring to any other engineering system. Not with hype. Not with fear. With clear eyes, honest measurement, and respect for both the technology's potential and its limitations.
